    ...
    <div class="flex items-center">
        @foreach ([['num' => 1, 'label' => 'Informations'], ['num' => 2, 'label' => 'Profil'], ['num' => 3, 'label' => 'Demandes']] as $step)
            ...
            <div class="flex flex-col items-center relative" style="z-index: 1;">
                {{-- Circle --}}
                <div class="flex items-center justify-center w-10 h-10 rounded-full border-2 transition-all duration-500 shadow-sm"
                    :class="{
                ...
                {{-- Label --}}
                <span class="mt-2 text-xs font-semibold tracking-wide transition-all duration-300 whitespace-nowrap"
                    :class="{
            ...
            @if (!$loop->last)
                <div class="flex-1 h-0.5 mx-1 -mt-5 rounded-full transition-all duration-500"
