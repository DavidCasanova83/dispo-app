<div class="flex h-full w-full flex-1 flex-col gap-4 rounded-xl">
    ...
    <div class="mb-4">
        ...
        <h1 class="text-3xl text-center font-bold text-gray-900 dark:text-white">Formulaire
            {{ $cityName }}</h1>
    </div>

    <!-- Formulaire Multi-étapes -->
    <div class="max-w-4xl mx-auto w-full">
        <div class="bg-white dark:bg-[#001716] shadow-lg rounded-lg p-6" x-data="{
            currentStep: 1,
            city: '{{ $city }}',
                        ...
                        <div class="flex items-center">
                            <div class="flex items-center text-sm"
                                ...
                                <div class="flex items-center justify-center w-8 h-8 rounded-full border-2"
                                    :class="currentStep >= 1 ? 'border-[#3E9B90] bg-[#3E9B90] text-white' :
                                        'border-gray-300 dark:border-gray-600 bg-white dark:bg-gray-800 text-gray-900 dark:text-gray-400'">
                                    1
                                </div>
                    ...
                    <div class="flex-1">
                        <div class="flex items-center">
                            <div class="flex items-center text-sm"
                                ...
                                <div class="flex items-center justify-center w-8 h-8 rounded-full border-2"
                                    :class="currentStep >= 2 ? 'border-[#3E9B90] bg-[#3E9B90] text-white' :
                                        'border-gray-300 dark:border-gray-600 bg-white dark:bg-gray-800 text-gray-900 dark:text-gray-400'">
                                    2
                                </div>
                    ...
                    <div class="flex-1">
                        <div class="flex items-center justify-end">
                            <div class="flex items-center text-sm"
                                ...
                                <div class="flex items-center justify-center w-8 h-8 rounded-full border-2"
                                    :class="currentStep >= 3 ? 'border-[#3E9B90] bg-[#3E9B90] text-white' :
                                        'border-gray-300 dark:border-gray-600 bg-white dark:bg-gray-800 text-gray-900 dark:text-gray-400'">
                                    3
                                </div>
            ...
            <div x-show="showSuccessMessage" x-transition:enter="transition ease-out duration-300"
                ...
                <div class="flex items-center">
                    ...
                    <span class="text-green-800 dark:text-green-200 font-semibold">Qualification enregistrée avec
            ...
            <div x-show="currentStep === 1" x-transition>
                ...
                <!-- Pays de résidence -->
                <div class="mb-6">
                    <label class="block text-lg font-semibold mb-3 text-gray-900 dark:text-white">Quel est le pays de
                        résidence ?</label>
                    <div class="flex flex-wrap gap-2">
                        <template
                            ...
                            <button type="button"
                                ...
                                class="px-4 py-2 rounded hover:bg-gray-200 dark:hover:bg-gray-600 transition-colors">
                    ...
                    <template x-if="country === 'Autre'">
                        <div class="mt-3">
                            <input type="text" x-model="otherCountry"
                                class="w-full px-4 py-2 border border-gray-300 dark:border-gray-600 rounded bg-white dark:bg-gray-800 text-gray-900 dark:text-white"
                ...
                <template x-if="country === 'France'">
                    <div class="mb-6">
                        <label class="block text-lg font-semibold mb-3 text-gray-900 dark:text-white">Préciser le
                            département</label>
                ...
                <!-- Email -->
                <div class="mb-6">
                    <label class="block text-lg font-semibold mb-3 text-gray-900 dark:text-white">Email
                        (optionnel)</label>
                ...
                <div class="space-y-3 mb-6">
                    <label class="flex items-start space-x-3 p-4 bg-gray-50 dark:bg-gray-800 rounded">
            ...
            <div x-show="currentStep === 2" x-transition>
                ...
                <!-- Profil -->
                <div class="mb-6">
                    <label class="block text-lg font-semibold mb-3 text-gray-900 dark:text-white">Définir le
                        profil</label>
                ...
                <!-- Tranches d'âge -->
                <div class="mb-6">
                    <label class="block text-lg font-semibold mb-3 text-gray-900 dark:text-white">Tranche(s) d'âge
                        correspondant</label>
                    <div class="flex flex-wrap gap-2 mb-2">
                ...
                <div class="flex gap-4">
                    <button type="button" x-on:click="previousStep()"
                        class="flex-1 bg-gray-200 text-gray-900 hover:bg-gray-300 dark:bg-gray-500 dark:text-white dark:hover:bg-gray-600 font-bold py-3 px-6 rounded-lg transition-colors">
                        Précédent
                    </button>
                    <button type="button"
            ...
            <div x-show="currentStep === 3" x-transition>
                ...
                <template x-if="specificOptions[city]">
                    <div class="mb-6">
                        <label class="block text-lg font-semibold mb-3 text-gray-900 dark:text-white">Demande
                ...
                <!-- Autres demandes -->
                <div class="mb-6">
                    <label class="block text-lg font-semibold mb-3 text-gray-900 dark:text-white">Autres, à
                        préciser</label>
