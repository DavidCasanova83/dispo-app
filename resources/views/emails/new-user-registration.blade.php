...
<head>
    ...
    <title>Nouveau utilisateur en attente d'approbation</title>
    <style>
        body {
...
<body>
    <div class="container">
        ...
        <div class="content">
            ...
            <p>
                Un nouvel utilisateur s'est inscrit sur l'application et est <strong>en attente d'approbation</strong>.
            </p>

            <p>
                Vous devez approuver cet utilisateur et lui attribuer un rôle avant qu'il puisse accéder à l'application.
            </p>
            ...
            <div class="info-box">
                ...
                <p>Nom : <strong>{{ $newUserName }}</strong></p>
            ...
            <p style="font-size: 14px; color: #6b7280; margin-top: 30px;">
                Vous pouvez approuver l'utilisateur et lui attribuer un rôle depuis le panel d'administration.
            </p>
        </div>
